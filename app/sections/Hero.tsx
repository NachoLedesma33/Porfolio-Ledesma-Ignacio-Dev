  ...
  return (
    <div className="scrollbar-hide relative w-full h-full flex flex-col items-center justify-center rounded-2xl shadow-xl ring-1 ring-rose-100/70 dark:ring-rose-950/40 overflow-y-auto">
      <SectionBackdrop active={active}>
        <div className="flex flex-col items-center justify-center text-center px-4 sm:px-6 min-h-[70vh]">
          {/* Greeting */}
          <p className="text-xl sm:text-2xl text-rose-600 dark:text-rose-400 font-medium mb-4 tracking-wide">
            Hola, soy
          </p>

          {/* Name */}
          <h1 className="section-heading text-6xl sm:text-7xl lg:text-8xl font-display tracking-tight mb-8">
          ...
          <div className="h-10 sm:h-12 flex items-center justify-center mb-12">
            <span className="text-2xl sm:text-3xl lg:text-4xl text-stone-700 dark:text-stone-200 font-semibold">
          ...
          <div className="flex flex-wrap items-center justify-center gap-4 sm:gap-5">
            <button
              ...
              className="px-6 sm:px-8 py-3 sm:py-3.5 bg-rose-600 hover:bg-rose-700 text-white font-semibold rounded-xl shadow-lg shadow-rose-500/25 hover:shadow-rose-500/40 transition-all duration-200 text-base sm:text-lg"
            >
              Ver Proyectos
            </button>
