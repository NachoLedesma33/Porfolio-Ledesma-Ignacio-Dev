        ...
        <div className="space-y-6">
          ...
          <div className="bg-rose-50/50 dark:bg-stone-800 rounded-lg p-6 ring-1 ring-rose-100/60 dark:ring-stone-700">
            ...
            <div className="flex space-x-4">
              <a href="https://github.com/NachoLedesma33" aria-label="GitHub" className="w-10 h-10 bg-stone-200 dark:bg-stone-600 rounded-full flex items-center justify-center hover:bg-rose-100 dark:hover:bg-rose-950/50 transition-colors">
              ...
              <a href="https://www.linkedin.com/in/nacho-ledesma" aria-label="LinkedIn" className="w-10 h-10 bg-stone-200 dark:bg-stone-600 rounded-full flex items-center justify-center hover:bg-rose-100 dark:hover:bg-rose-950/50 transition-colors">
                <svg className="w-5 h-5 text-stone-600 dark:text-stone-300" fill="currentColor" viewBox="0 0 24 24">
