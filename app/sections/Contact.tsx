        ...
        <div className="space-y-6">
            ...
            <div className="space-y-4">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-900 dark:text-white">nacholedesma33@gmail.com</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-900 dark:text-white">Cordoba Capital, Cordoba</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-6">
            ...
            <div className="flex space-x-4">
              <a href="https://github.com/NachoLedesma33" className="w-10 h-10 bg-gray-200 dark:bg-gray-600 rounded-full flex items-center justify-center hover:bg-orange-100 dark:hover:bg-orange-900 transition-colors">
              ...
              <a href="https://www.linkedin.com/in/nacho-ledesma" className="w-10 h-10 bg-gray-200 dark:bg-gray-600 rounded-full flex items-center justify-center hover:bg-orange-100 dark:hover:bg-orange-900 transition-colors">
                <svg className="w-5 h-5 text-gray-600 dark:text-gray-400" fill="currentColor" viewBox="0 0 24 24">
